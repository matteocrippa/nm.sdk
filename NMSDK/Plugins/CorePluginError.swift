...
public class CorePluginError: NSObject {
    ...
    ///
    /// - parameters:
    ///   - event: the source PluginEvent instance which represents the error; it must include fields `message` (`String`) and `error` (`Int`, convertible to a `NearSDKError` case), `event.from` must be convertible into a `CorePlugin` case
