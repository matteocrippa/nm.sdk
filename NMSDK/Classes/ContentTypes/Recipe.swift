...
/// A recipe which can be evaluated into "content" or "poll" reactions.
@objc
public class Recipe: NSObject {
    ...
    public init(recipe: APRecipe, contentReaction: APRecipeContent? = nil, pollReaction: APRecipePoll? = nil) {
        super.init()
